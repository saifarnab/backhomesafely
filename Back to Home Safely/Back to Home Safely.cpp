...
int cartimer, boattimer, timetimer, msec = 0;
int homecount = 0, homex[10];//homex[10] is boy's safe position value to the x-axis//
int randbgm, safebgm, randcar[6] = { 0, 1, 2, 3, 4, 2 }, randcarr[6] = { 0, 1, 2, 3, 4, 2 }; //randbgm=generates random number for background music.
...
int boatx1r = 1024, boatx3r = 600, boatx5r = 220, randboatr[6] = { 0, 1, 2, 0, 1, 2 };//reverse 2nd line boat position
int boatx2r = 850, boatx4r = 550, boatx6r = 230;//reverse 4th line boat position
...
void startgame()
{
	...
	iShowBMP(carx6, cary2, car[randcar[5]]);
	...
	iShowBMP(carx6r, cary2r, carrev[randcarr[5]]);
...
void carmove()
{
	...
	if (carx1 > 1100)
	{
		...
		randcar[0] = rand() % 5;
		if (carx2 >= -130 && carx2 <= -64 || carx3 >= -130 && carx3 <= -64)
			carx1 = -195;
		if (carx2 >= -64 && carx2 <= 0 || carx3 >= -64 && carx3 <= 0)
			carx1 = -130;
		else
			carx1 = -64;
	}
	if (carx2 > 1600)
	{
		srand((unsigned)time(NULL));
		randcar[1] = rand() % 5;
		if (carx1 >= -130 && carx1 <= -64 || carx3 >= -130 && carx3 <= -64)
			carx2 = -195;
		if (carx1 >= -64 && carx1 <= 0 || carx3 >= -64 && carx3 <= 0)
			carx2 = -130;
		else
			carx2 = -64;
	}
	if (carx3 > 1300)
	{
		srand((unsigned)time(NULL));
		randcar[2] = rand() % 5;
		if (carx1 >= -130 && carx1 <= -64 || carx2 >= -130 && carx2 <= -64)
			carx3 = -195;
		if (carx2 >= -64 && carx2 <= 0 || carx1 >= -64 && carx1 <= 0)
			carx3 = -130;
		else
			carx3 = -64;
	}
	if (carx4 > 1200)
	{
		srand((unsigned)time(NULL));
		randcar[3] = rand() % 5;
		if (carx5 >= -130 && carx5 <= -64 || carx6 >= -130 && carx6 <= -64)
			carx4 = -195;
		if (carx5 >= -64 && carx5 <= 0 || carx6 >= -64 && carx6 <= 0)
			carx4 = -130;
		else
			carx4 = -64;
	}
	if (carx5 > 1500)
	{
		srand((unsigned)time(NULL));
		randcar[4] = rand() % 5;
		if (carx4 >= -130 && carx4 <= -64 || carx6 >= -130 && carx6 <= -64)
			carx5 = -195;
		if (carx4 >= -64 && carx4 <= 0 || carx6 >= -64 && carx6 <= 0)
			carx5 = -130;
		else
			carx5 = -64;
	}
	if (carx6 > 1450)
	{
		srand((unsigned)time(NULL));
		randcar[5] = rand() % 5;
		if (carx4 >= -130 && carx4 <= -64 || carx5 >= -130 && carx5 <= -64)
			carx6 = -195;
		if (carx4 >= -64 && carx4 <= 0 || carx5 >= -64 && carx5 <= 0)
			carx6 = -130;
		else
			carx6 = -64;
	}
	...
	if (carx1r < -200)
	{
		srand((unsigned)time(NULL));
		randcarr[0] = rand() % 5;
		if (carx5r >= 1055 && carx5r <= 1120 || carx3r >= 1055 && carx3r <= 1120)
			carx1r = 1185;
		else
			carx1r = 1055;
		if (carx3r <= -435 && carx3r >= -500)
			carx3r = -435;
		if (carx5r <= -285 && carx5r >= -350)
			carx5r = -250;
	}
	if (carx3r < -500)
	{
		srand((unsigned)time(NULL));
		randcarr[2] = rand() % 5;
		if (carx1r >= 1055 && carx1r <= 1120 || carx5r >= 1055 && carx5r <= 1120)
			carx3r = 1185;
		else
			carx3r = 1055;
		if (carx1r <= -135 && carx1r >= -200)
			carx1r = -135;
		if (carx5r <= -285 && carx5r >= -350)
			carx5r = -250;
	}
	if (carx5r < -350)
	{
		srand((unsigned)time(NULL));
		randcarr[4] = rand() % 5;
		if (carx1r >= 1055 && carx1r <= 1120 || carx3r >= 1055 && carx3r <= 1120)
			carx5r = 1185;
		else
			carx5r = 1055;
		if (carx1r <= -135 && carx1r >= -200)
	...
	if (carx2r < -450)
	{
		srand((unsigned)time(NULL));
		randcarr[1] = rand() % 5;
		if (carx4r >= 1055 && carx4r <= 1120 || carx6r >= 1055 && carx6r <= 1120)
			carx2r = 1185;
		else
			carx2r = 1055;
		if (carx4r <= -185 && carx4r >= -250)
			carx4r = -185;
		if (carx6r <= -85 && carx6r >= -150)
			carx6r = -50;
	}
	if (carx4r < -250)
	{
		srand((unsigned)time(NULL));
		randcarr[3] = rand() % 5;
		if (carx2r >= 1055 && carx2r <= 1120 || carx6r >= 1055 && carx6r <= 1120)
			carx4r = 1185;
		else
			carx4r = 1055;
		if (carx2r <= -385 && carx2r >= -450)
			carx2r = -385;
		if (carx6r <= -85 && carx6r >= -150)
			carx6r = -50;
	}
	if (carx6r < -150)
	{
		srand((unsigned)time(NULL));
		randcarr[5] = rand() % 5;
		if (carx4r >= 1055 && carx4r <= 1120 || carx2r >= 1055 && carx2r <= 1120)
			carx6r = 1185;
		else
			carx6r = 1055;
		if (carx2r <= -385 && carx2r >= -450)
	...
	if (fastcarx1 >1250)
	{
		if (fastcarx2 >= -128 && fastcarx2 <= 0 || fastcarx3 >= -128 && fastcarx3 <= 0)
			fastcarx1 = -260;
		else
			fastcarx1 = -128;
		if (fastcarx2 >= 1400 && fastcarx2 <= 1530)
			fastcarx2 = 1400;
		if (fastcarx3 >= 1640 && fastcarx3 <= 1770)
			fastcarx3 = 1640;
	}
	if (fastcarx2 > 1530)
	{
		if (fastcarx1 >= -128 && fastcarx1 <= 0 || fastcarx3 >= -128 && fastcarx3 <= 0)
			fastcarx2 = -260;
		else
			fastcarx2 = -128;
		if (fastcarx1 >= 1120 && fastcarx1 <= 1250)
			fastcarx1 = 1120;
		if (fastcarx3 >= 1640 && fastcarx3 <= 1770)
			fastcarx3 = 1640;
	}
	if (fastcarx3 > 1770)
	{
		if (fastcarx2 >= -128 && fastcarx2 <= 0 || fastcarx1 >= -128 && fastcarx1 <= 0)
			fastcarx3 = -260;
		else
			fastcarx3 = -128;
		if (fastcarx1 >= 1120 && fastcarx1 <= 1250)
...
void boatmove()
{
	...
	if (boatx1 > 1350)
	{
		if (boatx2 >= 0 && boatx2 <= 256 || boatx3 >= 0 && boatx3 <= 256)
			boatx1 = -256;
		else
			boatx1 = 0;
		if (boatx2 >= 1044 && boatx2 <= 1300)
			boatx2 = 1044;
		if (boatx3 >= 1344 && boatx3 <= 1550)
			boatx2 = 1344;
	}
	if (boatx2 > 1300)
	{
		if (boatx1 >= 0 && boatx1 <= 256 || boatx3 >= 0 && boatx3 <= 256)
			boatx2 = -256;
		else
			boatx2 = 0;
		if (boatx1 >= 1094 && boatx1 <= 1350)
			boatx1 = 1344;
		if (boatx3 >= 1344 && boatx3 <= 1550)
			boatx2 = 1344;
	}
	if (boatx3 > 1550)
	{
		if (boatx2 >= 0 && boatx2 <= 256 || boatx1 >= 0 && boatx1 <= 256)
			boatx3 = -256;
		else
			boatx3 = 0;
		if (boatx1 >= 1094 && boatx1 <= 1350)
	...
	if (boatx4 > 1450)
	{
		if (boatx5 >= 0 && boatx5 <= 256 || boatx6 >= 0 && boatx6 <= 256)
			boatx4 = -256;
		else
			boatx4 = 0;
		if (boatx5 >= 1094 && boatx5 <= 1450)
			boatx5 = 1094;
		if (boatx6 >= 1344 && boatx6 <= 1600)
			boatx6 = 1344;
	}
	if (boatx5 > 1400)
	{
		if (boatx4 >= 0 && boatx4 <= 256 || boatx6 >= 0 && boatx6 <= 256)
			boatx5 = -256;
		else
			boatx5 = 0;
		if (boatx4 >= 1144 && boatx4 <= 1400)
			boatx4 = 1144;
		if (boatx6 >= 1344 && boatx6 <= 1600)
			boatx6 = 1344;
	}
	if (boatx6 > 1600)
	{
		if (boatx5 >= 0 && boatx5 <= 256 || boatx4 >= 0 && boatx4 <= 256)
			boatx6 = -256;
		else
			boatx6 = 0;
		if (boatx4 >= 1144 && boatx4 <= 1400)
	...
	if (boatx1r < -450)
	{
		if (boatx3r >= -550 && boatx3r <= -294 || boatx5r >= -350 && boatx5r <= -94)
			boatx1r = 1310;
		else
			boatx1r = 1055;
		if (boatx3r >= -550 && boatx3r <= -294)
			boatx3r = -294;
		if (boatx5r >= -350 && boatx5r <= -94)
			boatx5r = -94;
	}
	if (boatx3r < -550)
	{
		if (boatx1r >= -450 && boatx1r <= -194 || boatx5r >= -350 && boatx5r <= -94)
			boatx3r = 1310;
		else
			boatx3r = 1055;
		if (boatx1r >= -450 && boatx1r <= -194)
			boatx1r = -194;
		if (boatx5r >= -350 && boatx5r <= -94)
			boatx5r = -94;
	}
	if (boatx5r < -350)
	{
		if (boatx3r >= -550 && boatx3r <= -294 || boatx1r >= -450 && boatx1r <= -194)
			boatx5r = 1310;
		else
			boatx5r = 1055;
		if (boatx1r >= -450 && boatx1r <= -194)
	...
	if (boatx2r < -450)
	{
		if (boatx4r >= -250 && boatx4r <= 6 || boatx6r >= -600 && boatx6r <= -344)
			boatx2r = 1310;
		else
			boatx2r = 1055;
		if (boatx4r >= -250 && boatx4r <= 6)
			boatx4r = -1;
		if (boatx6r >= -600 && boatx6r <= -344)
			boatx6r = -44;
	}
	if (boatx4r < -250)
	{
		if (boatx2r >= -450 && boatx2r <= -194 || boatx6r >= -600 && boatx6r <= -344)
			boatx4r = 1310;
		else
			boatx4r = 1055;
		if (boatx2r >= -450 && boatx2r <= -194)
			boatx2r = -194;
		if (boatx6r >= -600 && boatx6r <= -344)
			boatx6r = -44;
	}
	if (boatx6r < -600)
	{
		if (boatx4r >= -250 && boatx4r <= 6 || boatx2r >= -450 && boatx2r <= -194)
			boatx6r = 1310;
		else
			boatx6r = 1055;
		if (boatx2r >= -450 && boatx2r <= -194)
...
void iMouse(int button, int state, int mx, int my)
{
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN && start == 1 && pauseflag == 0 && mx > 600 && mx < 600 + 128 && my>460 && my < 460 + 64)
	{
		pauseflag = 1;
	...
	else if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN && pauseflag == 1 && mx > 600 && mx < 600 + 128 && my>460 && my < 460 + 64)
	{
		pauseflag = 0;
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN && mx > 0 && mx <= 50 && my> 470 && my < 500)
	{
		life++, second += 20;
	}
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN && start == 0 && mx > 80 && mx < 128 + 80 && my>375 && my < 375 + 128)
	{
		...
		start = 1, boyx = 490, boyy = 17, second = secondtag + 30, score = 0, life = lifetag, win = wintag, homecount = 0, wincount = 0, scoreflag = 0, helpflag = 0, aboutusflag = 0, level = 1, speed = speedtag, winflag = 0, lossflag = 0, pauseflag = 0, wb = 0, boatride = 0, walk = 0;
		counttimer();
		iResumeTimer(cartimer);
		iResumeTimer(boattimer);
		iResumeTimer(timetimer);
